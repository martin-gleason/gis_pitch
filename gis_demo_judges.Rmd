...
# Server to Server
.pull-left[
![:scale 120%](imgs/GIS_ERD.JPG)
]
.pull-right[
* Diagram shows how each server/service communicates witht the other

* It shows the boundaries between GIS and OCJ

* It represents privacy and processing concerns 

* Diagram illustrates that GIS would only process, and not store, OCJ Data
]
...
---
# Next Steps:
* Frame OCJ Data to different geographic locations
  * Courtroom
